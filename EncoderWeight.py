...
# tf.enable_eager_execution() No need, eager execution is enabled by default in TF 2.0 or above
...
class EncoderWeight:
    def __init__(self, graph_train, graph_test, pattern1train, pattern2train, pattern3train, pattern1test, pattern2test,
        ...
        # The graph feature and the pattern feature are fed into the AME network for giving the final detection result and the interpretable weights.
